  ...
  return (
    ...
    >
      ...
      <MenuList sx={{ py: 1 }}>
        ...
        >
          <ListItemIcon>{hasLocalPath ? <PlayCircleOutlineIcon /> : <SyncIcon />}</ListItemIcon>
          <ListItemText
            primary={
              hasLocalPath
        ...
        >
          <MenuItem>
            ...
            <ListItemText primary={t("components.RightMenu.enterDetails", "进入详情页")} />
          </MenuItem>
        </LinkWithScrollSave>
        ...
        <MenuItem onClick={() => setOpenAlert(true)}>
          ...
          <ListItemText primary={t("components.RightMenu.deleteGame", "删除游戏")} />
        </MenuItem>
        ...
        >
          ...
          <ListItemText primary={t("components.RightMenu.openGameFolder", "打开游戏目录")} />
        </MenuItem>
